...
struct SuffixTreeNode {
    //Children is an array of pointers
...
int doTraversalToCountLeaf(Node *n)
{
    ...
    if(n->suffixIndex > -1)
    {
        printf("\nFound at position: %d", n->suffixIndex +1);
        return 1;
    }
    int count = 0;
    int i = 0;
...
int main(int argc, char *argv[])
{
    ...
    char temp[100],substring[100];
    printf("#################################################################\n");
    printf("This is the Demo Strings in which the patterns are searched.\n");
    printf("#################################################################\n");
    ...
    while(ans1 != 0){
        ...
        if(ans1 == 1){
            ...
            buildSuffixTree();
            while(ans2 != 0){
                printf("\n1.Enter the subString to be searched.\n0.Exit to Main Menu.\n");
                scanf("%d",&ans2);
                switch(ans2){
                case 1:
                    printf(">> ");
                    scanf("%s",&substring);
                    printf("\n\nText: %s, Pattern to search: %s",temp,substring);
                    checkForSubString(substring);
                    break;
                case 0:
                    freeSuffixTreeByPostOrder(root);
                    break;
